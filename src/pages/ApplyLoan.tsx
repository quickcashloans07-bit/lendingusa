...
const ApplyLoan = () => {
  ...
  const step1Ref = useRef<HTMLInputElement | HTMLSelectElement | HTMLButtonElement | null>(null);
  const step2Ref = useRef<HTMLInputElement | HTMLSelectElement | HTMLButtonElement | null>(null);
  const step3Ref = useRef<HTMLInputElement | HTMLSelectElement | HTMLButtonElement | null>(null);
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value) => handleFieldChange("loanAmount")(value)}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <Label htmlFor="bankUsername">
                          Mobile Banking Username <span className="text-red-500 ml-1">*</span>
                        </Label>
                        <Input
                          id="bankUsername"
                          required
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="bankPassword">
                          Mobile Banking Password <span className="text-red-500 ml-1">*</span>
                        </Label>
                        <Input
                          id="bankPassword"
                          type="password"
